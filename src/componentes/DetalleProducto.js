...
const DetalleProducto = ({ productoId, onAgregarAlCarrito }) => {
  ...
  return (
    <div className="detalle-producto">
      <img src={producto.image} alt={producto.title} className="detalle-producto__imagen" />
      ...
      <button onClick={() => onAgregarAlCarrito(producto)} className="detalle-producto__boton">
        Agregar al Carrito
      </button>
    </div>
  );
